...
async function seedNotificationTemplates() {
  try {
    console.log('🌱 Iniciando inserción de plantillas de notificaciones...');
    ...
    const templates = [
      ...
      // Notificaciones para organizadores
      {
    ...
    console.log('🎉 Plantillas de notificaciones insertadas exitosamente!');
