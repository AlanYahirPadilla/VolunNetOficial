  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex flex-col">
      ...
      <div className="flex-1 w-full">
        {/* Header de la página mejorado - Fondo pastel AÚN MÁS CLARO (100) */}
        <div className="relative bg-gradient-to-r from-teal-100 via-blue-100 to-purple-100 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-6 py-8">
            ...
            {/* MODIFICADO: Estilo del título principal - TAMAÑO AUMENTADO (text-6xl) */}
            <motion.div 
            ...
            >
              ...
              <div className="h-16 w-16 bg-white/50 rounded-2xl flex items-center justify-center backdrop-blur-sm">
                <Settings className="h-8 w-8 text-gray-700" /> 
              </div>
              <div>
                <h1 className="text-6xl font-extrabold bg-gradient-to-r from-blue-700 to-purple-700 bg-clip-text text-transparent mb-2" style={{ textShadow: '0px 4px 6px rgba(0, 0, 0, 0.1), 0px 2px 4px rgba(0, 0, 0, 0.05)' }}>
                  Configuración de Organización
                </h1>
                <p className="text-gray-700 text-lg">Gestiona la configuración y preferencias de tu organización</p> 
              </div>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-5 gap-8">
            ...
            <div className="xl:col-span-2">
              ...
              >
                <Card className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-gray-200/50 overflow-hidden">
                  {/* Header de la Card a gradiente pastel y texto oscuro */}
                  <CardHeader className="bg-gradient-to-r from-blue-100 via-pink-100 to-purple-100 text-gray-800 p-6">
                    <CardTitle className="text-xl font-bold flex items-center gap-3">
                      <div className="h-8 w-8 bg-white/50 rounded-xl flex items-center justify-center">
                        <Settings className="h-4 w-4 text-gray-700" />
                      </div>
                      Configuración
                    </CardTitle>
                    <p className="text-gray-700 text-sm">Selecciona una sección para configurar</p>
                  </CardHeader>
                        ...
                        return (
                          <motion.button
                            ...
                            className={`w-full flex items-center gap-4 px-4 py-4 rounded-2xl text-left transition-all duration-200 group ${
                              activeTab === tab.id
                                // Botón activo a gradiente pastel y texto oscuro
                                ? "bg-gradient-to-r from-blue-200 to-purple-300 text-gray-800 shadow-lg shadow-blue-200/50"
                                : "text-gray-600 hover:bg-gray-50 hover:shadow-md"
                            }`}
                          >
                            <div className={`h-10 w-10 rounded-xl flex items-center justify-center transition-all duration-200 ${
                              activeTab === tab.id
                                // Fondo de ícono activo a blanco/claro
                                ? "bg-white/50"
                                : "bg-gray-100 group-hover:bg-blue-100"
                            }`}>
                              <Icon className={`h-5 w-5 transition-colors duration-200 ${
                                activeTab === tab.id 
                                // Ícono activo a color oscuro
                                ? "text-gray-700" : "text-gray-600 group-hover:text-blue-600"
                              }`} />
                            </div>
            ...
            <div className="xl:col-span-3">
              ...
              {activeTab === "perfil" && (
                ...
                >
                  <Card className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-gray-200/50 overflow-hidden">
                    <CardHeader className="bg-gradient-to-r from-blue-100 via-pink-100 to-purple-100 text-gray-800 p-8">
                      <CardTitle className="text-2xl font-bold flex items-center gap-3">
                        <div className="h-10 w-10 bg-white/50 rounded-2xl flex items-center justify-center">
                          <User className="h-5 w-5 text-gray-700" />
                        </div>
                        Información del Perfil
                      </CardTitle>
                      <p className="text-gray-700 mt-2">Actualiza la información básica de tu organización</p>
                    </CardHeader>
                    <CardContent className="p-8 space-y-8">
                      ...
                      <div className="flex justify-end">
                        <Button 
                          ...
                          disabled={saving}
                          // Botón principal de guardar a gradiente pastel y texto oscuro
                          className="bg-gradient-to-r from-pink-300 to-purple-300 hover:from-pink-400 hover:to-purple-400 text-gray-800 rounded-xl px-8"
                        >
                          {saving ? (
                            <>
                ...
                >
                  <Card className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-gray-200/50 overflow-hidden">
                    <CardHeader className="bg-gradient-to-r from-blue-100 via-pink-100 to-purple-100 text-gray-800 p-8">
                      ...
                      <p className="text-gray-700 mt-2">Personaliza cómo y cuándo recibir notificaciones</p>
                    </CardHeader>
                ...
                >
                  <Card className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-gray-200/50 overflow-hidden">
                    <CardHeader className="bg-gradient-to-r from-blue-100 via-pink-100 to-purple-100 text-gray-800 p-8">
                      ...
                      <p className="text-gray-700 mt-2">Controla qué información es visible para otros usuarios</p>
                    </CardHeader>
                    <CardContent className="p-8 space-y-6">
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                ...
                >
                  <Card className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-gray-200/50 overflow-hidden">
                    <CardHeader className="bg-gradient-to-r from-blue-100 via-pink-100 to-purple-100 text-gray-800 p-8">
                      ...
                      <p className="text-gray-700 mt-2">Gestiona la seguridad de tu cuenta</p>
                    </CardHeader>
                    <CardContent className="p-8 space-y-6">
                      <div className="space-y-4">
                        <div className="space-y-2">
